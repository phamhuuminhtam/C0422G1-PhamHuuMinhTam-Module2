...
//
        ...
        do {
            System.out.println("nhập mã dich vụ : SVHO-YYYY, với YYYY là các số từ 0-9:");
        ...
        facilityIntegerMap.put(new House(serviceCode,serviceName,squareUse,cost,numberOfPeople,rentalType,numberOfFloors,roomStandard),0);
